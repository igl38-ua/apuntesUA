...
En el caso de [[#Búsqueda de un elemento en un vector]] si que hay mejor y peor porque una vez se encuentra el elemento detiene la ejecución. Pero en este caso el bucle siempre se ejecuta n veces.
